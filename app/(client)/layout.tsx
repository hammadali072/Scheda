...
//
// Client dashboard layout shell. Renders a responsive drawer sidebar navigation
// matching the style tokens in mui-theme.tsx and utilizing Phosphor icons.
// Personalized for a mock Client (Bilal Ahmed) to demonstrate Phase 1 logic.
...
const navItems: NavItem[] = [
    { text: "Browse Members", href: "/client/dashboard", icon: MagnifyingGlassIcon },
    { text: "My Appointments", href: "/client/my-appointments", icon: CalendarIcon },
    { text: "Profile", href: "/client/profile", icon: UserIcon },
];
...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
    ...
    // Mock authenticated client (Bilal Ahmed)
    ...
    const pageTitle = currentNavItem ? currentNavItem.text : "Client Panel";
    ...
    const sidebarContent = (
        <Box className="flex flex-col h-full bg-paper text-primary-text">
            ...
            {/* Client Profile Section at bottom of Sidebar */}
