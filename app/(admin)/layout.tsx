...
//
// Admin dashboard layout shell. Renders a responsive drawer sidebar navigation
...
const navItems: NavItem[] = [
    { text: "Dashboard", href: "/admin/dashboard", icon: HouseIcon },
    { text: "Members", href: "/admin/members", icon: UsersIcon },
    { text: "Designations", href: "/admin/designations", icon: TagIcon },
    { text: "Clients", href: "/admin/clients", icon: HandshakeIcon },
    { text: "Appointments", href: "/admin/appointments", icon: CalendarIcon },
    { text: "Settings", href: "/admin/settings", icon: GearIcon },
];
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const pageTitle = currentNavItem ? currentNavItem.text : "Admin Panel";
        ...
        <Box sx={{ display: "flex", minHeight: "screen" }} className="bg-zinc-50 dark:bg-[#0a0a0a] transition-colors duration-300">
            ...
            >
                <Toolbar className="flex justify-between items-center px-6 h-16">
                    ...
                    {/* Top bar right area, holding Theme Switcher */}
                    <div className="flex items-center gap-4">
                        {/* Empty space or additional topnav items */}
                    </div>
                </Toolbar>
            </AppBar>
