...
type ParagraphSize = 'extra-small' | 'extra-small-medium' | 'extra-small-semibold' | 'extra-small-bold' | 'small' | 'small-medium' | 'small-semibold' | 'small-bold' | 'base' | 'base-medium' | 'base-semibold' | 'base-bold' | 'large' | 'large-medium' | 'large-semibold' | 'large-bold' | 'extra-large' | 'extra-large-medium' | 'extra-large-semibold' | 'extra-large-bold';
...
const TitleComponent: React.FC<TitleComponentProps> = ({
    ...
    return (
        <Tag className={clsx(typeClass, className)}>
            {children}
        </Tag>
    );
};
